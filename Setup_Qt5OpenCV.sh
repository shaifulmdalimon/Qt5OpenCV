...
echo "Qt5 and OpenCV installation script"
...
echo "Install Qt5 documentation"
...
### You can change 4 with the number of your cpu core, 
make -j4 
make install


echo "Qt5 and OpenCV installation is complete"
